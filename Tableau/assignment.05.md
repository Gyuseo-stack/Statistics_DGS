...
- Fixed에서 설정한 차원이 뷰에 포함되어 있을 때 사용
- Fixed에서 설정한 차원이 뷰에 포함되어 있지 않을 때
<img width="925" height="316" alt="스크린샷 2026-04-03 오후 5 01 25" src="https://github.com/user-attachments/assets/c386cbea-1a3c-4d7e-9c2a-00d8e087e374" />
